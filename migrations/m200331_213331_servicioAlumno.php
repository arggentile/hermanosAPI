 ...
 */
class m200331_213331_servicioAlumno extends Migration
{
    /**
     * {@inheritdoc}
     */
...
echo "Migracion Tablas Servicios Alumno.\n";
        ...
        $this->addForeignKey('fk_servicioAlumno_servio', 'servicio_alumno', 'id_servicio', 'servicio_divisionescolar', 'id');
