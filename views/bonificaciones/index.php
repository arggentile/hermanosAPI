...
$this->title = 'Gestión Bonificaciones Automaticas';
$this->params['breadcrumbs'][] = $this->title;
?>
<?= \app\widgets\modalcrud\ModalCrud::widget(['titulo'=>'Alta/Actualización Bonificaciones']); ?>
<div id="tipo-bonificacionautomaticas-index">
    ...
    <div class="box box-default">
        ...
        <div class="box-body">
            ...
            <?=  Html::a('<i class="glyphicon glyphicon-plus"></i>', ['create'], ['class' => 'btn btn-success btn-alta btn-xs', 'data-title'=>'Alta',
                'onclick'=>'js:{cargaAjax("'.Url::to(['/bonificaciones/create']) .'"); return false;}']); ?>
            </p>
                    ...
                    'columns' => [
                        ...
                        'value' => function($model) {
                            if($model->activa=='0')
                                ...
                                [
                        'label' => 'Automatiza',
                        'attribute'=>'automatica',    
                        'filter'=> dmstr\helpers\Html::activeDropDownList($searchModel, 'automatica', ['0'=>'NO','1'=>'SI'],['prompt'=>'','class'=>'form-control']),
                        'value' => function($model) {
                            if($model->automatica=='0')
                                return "No";
                            else
                                return "Si";
                        },
