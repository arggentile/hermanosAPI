                ...
                'items' => [
                    [
                        ...
                        'items' => [
                            ...
                            ['label' => 'Egresar', 'icon' => 'arrow-right', 'url' => ['/alumno/egresar-alumnos'], 'visible' => Yii::$app->user->can('egresarAlumnos')],           
                        ],
...
//                    ],
                    ...
                    [
                        ...
                        'items' => [
                            ...
                            ['label' => 'Alumnos con Bonificación', 'icon' => 'fa fa-arrow-right', 'url' => ['/alumno/bonificaciones-alumno'], 'visible' => Yii::$app->user->can('gestionarBonificacionAlumno')],         
                        ],
